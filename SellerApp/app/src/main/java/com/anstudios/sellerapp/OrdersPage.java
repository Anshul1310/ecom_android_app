...
import com.anstudios.sellerapp.adapters.adapterOrdersPage;
import com.anstudios.sellerapp.models.modelOrders;
import com.anstudios.sellerapp.models.modelOrdersPage;
...
public class OrdersPage extends AppCompatActivity {
    ...
    private TextView orderId, dateTime, quantity, paymentType, totalPrice,note;
...
//
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                if(seller.equals(SplashScreen.sharedPreferences.getString("id",""))){
